    ...
    return (
        <div className="bg-register h-screen bg-cover bg-no-repeat flex items-center justify-center">
            <div className="form-sign-up flex flex-col items-center justify-center bg-[#2B2B2B] rounded-xl w-[40%]">
                <div className="title text-3xl font-bold mt-8 mb-5">Sign in to
                ...
                <div className="tips text-[#ADADAD] text-xs font-bold mb-4">Or using your email</div>
                ...
                <div className="tips text-[#ADADAD] text-xs font-bold mt-4 underline">Forgot your password?</div>
                <div className="btn-sign-up bg-primary text-sm font-normal rounded-3xl px-6 py-2 flex justify-center items-center mt-4 mb-8 cursor-pointer">SIGN IN</div>
            </div>
        </div>
    );
};
